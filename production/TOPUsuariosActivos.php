                ...
                <div class="">
					...
					<div class="col-md-5 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 10 Wikis with most active users</h2>
					...
					<!-- Aquí está la segunda línea-->
						...
						<div class="col-md-7 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Wikis with active users on Wikia<small>% active users</small></h2>
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>The 10 Wikis with most active users<small>number of active users</small></h2>
