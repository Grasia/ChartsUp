...
<head>
    ...
    <title>ChartsUp - Top Reversors </title>
                ...
                <div class="">
					...
					<div class="col-md-5 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 10 Wikis users more reversors</h2>
					...
					<!-- Aquí está la segunda línea-->
						...
						<div class="col-md-7 col-sm-9 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Wikis with reversors users on Wikia<small>% reversors users</small></h2>
                            ...
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>The 10 Wikis with most reversors users<small>number of reversors users</small></h2>
