            ...
            <div class="right_col" role="main">
					...
					<div class="col-md-5 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
                                            ...
                                            <div class="x_title">
                                                <h2>Top 10 Wikis users more editions</h2>
					...
					<!-- Aquí está la segunda línea-->
						...
						<div class="col-md-7 col-sm-9 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Wikis with editions on Wikia<small>% editions</small></h2>
						   ...
						   <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>The 10 Wikis with most editions<small>number of editions</small></h2>
